...
<body class="bg-white text-[#3b4a1b] font-sans">
    ...
    <!-- Navbar -->
    <header class="fixed top-0 w-full bg-[#3b4a1b] text-white shadow-lg px-[150px]">
    ...
    <!-- Hero Section -->
    <section id="hero" class="flex flex-col md:flex-row items-center justify-between px-10 py-20 mt-20 bg-white container mx-auto px-4 px-[150px]">
...
<section id="about-us" class="px-[200px] py-20 bg-[#3b4a1b] text-white text-center">
    ...
    <!-- Products Section -->
    <section id="products-section" class="px-10 py-20 text-center bg-white px-[150px]">
    ...
    <!-- Footer -->
    <footer class="bg-[#3b4a1b] text-white py-8 px-[150px]">
